        ...
        <div className="flex flex-col items-center min-h-screen bg-gray-50 p-6">
            <div className="bg-white shadow-md rounded-md p-6 max-w-lg w-full">
                <h1 className="text-2xl font-semibold text-center text-gray-900 mb-4">
                    {error ? "Error during order" : "Confirmation of order"}
                </h1>
                ...
                {error ? (
                    <>
                        ...
                        <p className="text-sm text-center text-gray-600 mt-2">
                            The order could not be completed. Please try again. If problems persist, please contact
                            support{" "}
                            <a
                    ...
                    <>
                        ...
                        <div className="mt-4 p-3 border rounded-md text-gray-900">
                            ...
                            <p>
                                <strong>Total price:</strong> {order?.totalAmount} CZK
                            </p>
                        </div>

                        <h3 className="text-lg font-semibold text-gray-900 mt-4">Purchased tickets:</h3>
                        <ul className="list-disc pl-5 text-gray-600">
                            {order?.tickets.map((ticket: any, index: number) => (
                                <li key={index}>
                                    Ticket #{index + 1} – Seat ID: {ticket.seatId}
                                </li>
                            ))}
                        </ul>
                    </>
